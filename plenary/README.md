...
- Thanks, Simon!
- I’m going to show two new capabilities that bring the ArcGIS system and R closer together
...
- Ill now upload a CSV file which falls within the expected extent
...
* go back to the trace downstream thing*
